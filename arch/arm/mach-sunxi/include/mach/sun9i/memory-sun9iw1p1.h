...
#define SUNXI_FIRMWARE_BASE	(SUPER_STANDBY_MEM_BASE + SUPER_STANDBY_MEM_SIZE + SZ_64K)
#define SUNXI_FIRMWARE_SIZE	(SZ_2M)

#define SUNXI_A1_BASE	SUNXI_FIRMWARE_BASE
#define SUNXI_A1_SIZE	SZ_256K

#define SUNXI_A2_BASE	(SUNXI_A1_BASE + SZ_256K)
#define SUNXI_A2_SIZE	SZ_256K

#define SUNXI_A3_BASE	(SUNXI_A3_BASE + SZ_256K)
#define SUNXI_A3_SIZE	SZ_256K
